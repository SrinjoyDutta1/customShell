...
{
       0,   182,   182,   186,   187,   190,   194,   198,   199,   203,
     204,   208,   215,   216,   220,   236,   248,   249,   250,   254,
     263,   268,   273,   279,   283,   290,   293
};
#endif
...
{
  "$end", "error", "$undefined", "WORD", "GREAT", "NEWLINE", "PIPE",
  "AMPERSAND", "LESS", "GREATERAMP", "GREATGREAT", "GREATGREATAMPERSAND",
  "NOTHING", "TWOGREAT", "$accept", "goal", "commands", "command",
...
{
      19,    -2,    -5,    -5,     1,    18,    -5,    -5,    -4,    -5,
      -5,    -5,    -5,    -5,     7,    13,    22,    23,    24,    25,
      26,     4,    -5,    27,    -5,    -5,    -5,    -5,    -5,    -5,
      -5,    -5,    -5,    28,    -5,    -5,    -5
};
...
{
      14,    12,    15,    11,    16,    17,    18,    19,    14,    20,
      24,    31,    16,    17,    18,    19,     2,    20,    -2,     1,
       1,     2,     2,     3,     3,    26,    27,    28,    29,    30,
      34,    25,    32,    36,    13
};

static const yytype_int8 yycheck[] =
{
       4,     0,     6,     5,     8,     9,    10,    11,     4,    13,
       3,     7,     8,     9,    10,    11,     3,    13,     0,     1,
       1,     3,     3,     5,     5,     3,     3,     3,     3,     3,
       3,    15,    21,     5,     5
};
